...
var fullSet = function () {
  ...
  for (var i = 0; i < alpha.length; i++) {
    s[i].targetCenter = {
      x:
        (i % 10) * colUnit - ((col - 1) * colUnit) / 2 - window.innerWidth * 10,
...
var start = function () {
  ...
  setInterval(function () {
    ...
    if (invertCV.execution() > 0.7) {
      strokeColor = 'rgba(0,102,255,0.7)';
      background = 'url(./img/section14_bg.jpg)';
    } else {
      strokeColor = 'rgba0,102,255,0.7)';
      background = 'url(./img/section14_bg.jpg)';
    }
...
document.body.onmousemove = function (e) {
  camera.rotate.x = (e.pageY / window.innerHeight) * 360 + 30;
